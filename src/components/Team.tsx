...
const Team = () => {
    ...
    const teamMembers = [
        ...
        { 
            name: "Michael Wilcox",
            role: "Web Learning Assistant",
            description: "Michael has got a myriad of expreience in cross functional teams to leverage the best yield of education in the BD labs team",
            image: michael 
        },
        { 
            name: "Patrick Reynolds",
            role: "DS Learning Assistant",
            description: "Patrick has got a myriad of expreience in cross functional teams to leverage the best yield of education in the BD labs team",
            image: michael 
        }
    ];
    return (
        <div className="bg-gray-50 py-16 bg-[#145074]" id="team">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-600">Meet the People Behind Labs</h2>
                <p className="text-gray-400 text-lg mt-2">Decades of combined Engineering Experience</p>
